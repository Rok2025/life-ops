...
CREATE INDEX idx_growth_projects_area_status ON growth_projects (area, status);
CREATE INDEX idx_growth_projects_area_scope ON growth_projects (area, scope);
...
CREATE INDEX idx_project_todos_project ON project_todos (project_id, is_completed);
...
CREATE INDEX idx_project_notes_todo ON project_notes (todo_id);
