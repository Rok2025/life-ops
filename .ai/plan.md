...
按用户确定的顺序：先清理无关前后端功能，最后处理数据库表和云资源。

权威计划位于 [健身与财务彻底收缩实施方案](../docs/fitness-finance-simplification-plan.md)；执行结果见 [应用清理验证记录](../docs/audits/2026-09-07-application-cleanup-results.md)。
