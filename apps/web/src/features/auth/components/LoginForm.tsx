...
export default function LoginForm() {
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-bg-primary">
            ...
            <Card className="w-full max-w-md p-8 backdrop-blur-2xl bg-white/5 border-white/10 shadow-lg relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-1.5">
                        <label className="text-caption font-medium text-text-tertiary uppercase ml-1">
                            邮箱地址
                        </label>
                    ...
                    {error && (
                        <div className="text-caption text-danger bg-danger/10 p-3 rounded-card border border-danger/20">
                            {error}
                        </div>
                    )}
                    ...
                    <Button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 rounded-card gap-2 font-semibold shadow-lg shadow-accent/20 active:scale-[0.98] transition-all"
                    >
                        {loading ? (
